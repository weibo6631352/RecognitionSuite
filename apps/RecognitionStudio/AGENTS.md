...
- Integrate VoiceEngine and ScanEngine through their published SDKs only. Do not copy product source code into this repository.
...
- Do not commit SDK DLLs, models, generated output, or build directories.
